...
export const CALCULATORS: CalculatorMeta[] = [
  ...
  },
  {
    ...
    name: 'calculators.currencyConverter.name',
    shortDesc: 'calculators.currencyConverter.shortDesc',
    category: 'finance',
  ...
  {
    id: 'prime-checker',
    name: 'calculators.primeChecker.name',
    shortDesc: 'calculators.primeChecker.shortDesc',
    category: 'math',
    icon: 'search-outline',
    color: COLORS.category.math,
  },
  ...
  },
  {
    ...
    name: 'calculators.permutationCombination.name',
    shortDesc: 'calculators.permutationCombination.shortDesc',
    category: 'math',
